...
def evaluate(config: ml_collections.ConfigDict, workdir: str):
    ...
    for a,b,c,d in config.data_idx:
        ...
        # Get dataset
        (L, t, t_dense, g, m0, m1, m2, l, q0, q1, q2, u_control, x_without_noise) = get_dataset(N=151, a=a, b=b, c=c, d=d) #100000
        ...
        plt.scatter(t_ori, q_gt[:,0], color='red', s = 3.)
        plt.scatter(t_ori, q_gt[:,1], color='mediumblue', s = 3.)
        plt.scatter(t_ori, q_gt[:,2], color='darkgreen', s = 3.)
